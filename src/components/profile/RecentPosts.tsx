...
const RecentPosts = () => {
  ...
  const { data: sneakersProfile, isLoading } =
    useGetMyRecentSneakersProfileQuery(
      subscriptionId ? { id: subscriptionId } : skipToken
    )
  ...
  if (sneakersData.length === 0) {
    return (
      <div className="text-center text-gray-500 py-20">
        <h3 className="text-xl mb-4">No sneakers found</h3>
        <p>You haven&apos;t posted any sneakers yet.</p>
      </div>
    )
  }
